...
video_path = r'E:\Major Project\Countine_Vehicles_InLanes\demoVideo.mp4'
...
road_zoneA = np.array([[308, 769], [711, 787], [694, 472], [415, 472], [309, 770]], np.int32)
road_zoneB = np.array([[727, 777], [1123, 792], [1001, 496], [741, 505], [730, 775]], np.int32)
road_zoneC = np.array([[1116, 681], [1533, 561], [1236, 347], [1009, 422], [1122, 678]], np.int32)
...
while True:
    ...
    try:
        ...
        print("Error resizing frame. Skipping this frame.")
        continue
